...
export const TopBar = memo(function TopBar({ actions, className }: TopBarProps) {
  ...
  return (
    <div
      className={cn(
        "h-14 flex items-center justify-between px-6 border-b border-slate-200/80 flex-shrink-0 bg-white/80 backdrop-blur-xl z-10 shadow-sm",
        className
      )}
    >
      {/* Breadcrumbs */}
