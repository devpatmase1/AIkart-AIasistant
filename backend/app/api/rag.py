...
async def debug_chat(
    ...
    user_parts.append(
        ...
        "- NEVER say 'the document does not contain this information' or 'no information' for data that IS present "
        ...
        "\"The document does not contain this information.\" without any citations.\n"
